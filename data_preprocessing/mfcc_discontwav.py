...
import os
idx_wav='Baycrest12814'

fs, wavdata = wavfile.read("./denoise_Bay/Baycrest12814.wav") # read a wav file into numpy array
...
# Create a CSV file with MFCCs
file_name = f'{idx_wav}.csv'
